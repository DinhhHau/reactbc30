...
export default class BaiTapRenderMap extends Component {
    ...
    //----------- Cách1
  //   renderFlim = () => {
  //     return data.map((flim, i) => {
  //       return (
  //         <div className="col-2" key={i}>
  //           <div className="card">
  //             <img src={flim.hinhAnh} alt="..." />
    ...
    return (
      <div className="content">
        <div style={{ minHeight: "100vh", background: "rgba(0,0,0,.5)" }}>
          {/* bs5-navber-background => chỉnh màu */}
          <nav
          ...
          <div className="container-fluid">
            <div className="row">
              ...
              {data.map((flim, i) => {
                return (
                  <div className="col-md-3 col-lg-2 mt-2" key={i}>
                    <div className="card">
                      <img src={flim.hinhAnh} alt="..." height={350} />
                      <div className="card-body bg-dark text-white">
                        <h3 style={{height:75, fontSize:20}} >{flim.tenPhim}</h3>
                        <p style={{height:100}} >{flim.moTa.length > 100 ? flim.moTa.substring(0,100) + '...' : flim.moTa }</p>
                      </div>
                    </div>
                  </div>
                );
